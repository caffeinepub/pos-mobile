...
export default function Contactar() {
  ...
  const email = "yosmelpalmero@nauta.cu";

  return (
    <div className="flex flex-col flex-1 items-center justify-center px-8 py-12 text-center gap-6">
      <div>
        <h2 className="text-2xl font-bold text-foreground">Contactar</h2>
      ...
      <div className="flex gap-8">
        <a
          ...
          data-ocid="contactar.whatsapp.button"
        ...
        <a
          href="https://t.me/YossNoa"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Contactar por Telegram"
          data-ocid="contactar.telegram.button"
          className="flex flex-col items-center gap-2 group"
        >
          <div className="w-16 h-16 rounded-2xl bg-sky-500/10 flex items-center justify-center group-hover:bg-sky-500/20 transition-colors">
        ...
        <a
          ...
          data-ocid="contactar.email.button"
          className="flex flex-col items-center gap-2 group"
        >
